...
namespace Nexos.WebApi.Controllers
{
    public class LibroController : ApiController
    {
        ...
        public bool put(Libro libro)
        {
            ...
            libroActualizar.NumPaginas = libro.NumPaginas;
            libroActualizar.NomAutor = libro.NomAutor;
            libroActualizar.FechaNacimientoAutor = libro.FechaNacimientoAutor;
            libroActualizar.CiudadAutor = libro.CiudadAutor;
            libroActualizar.CorreoElectronicoAutor = libro.CorreoElectronicoAutor;
